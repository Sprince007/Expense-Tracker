      ...
      <div className="max-w-xl lg:max-w-3xl">
        <div className="relative -mt-16 block lg:hidden">
          ...
          <p className="mt-4 leading-relaxed text-gray-500">
            Don't let another month go by without truly understanding your money. Sign up now and start taking the first steps towards a healthier, happier financial future.
          </p>
        </div>
